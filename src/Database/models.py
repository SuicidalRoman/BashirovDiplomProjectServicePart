...
from sqlalchemy import Boolean, Enum, MetaData, Table, Column, String, Integer, TIMESTAMP, ForeignKey, Date, CheckConstraint, text
...
users = Table(
    ...
    Column("registered_at", TIMESTAMP(timezone=True), server_default=text('NOW()')),
...
events = Table(
    ...
    Column("start_timestamp", TIMESTAMP(timezone=True), nullable=False),
    Column("end_timestamp", TIMESTAMP(timezone=True), nullable=False),
    Column("created_at", TIMESTAMP(timezone=True), server_default=text('NOW()')),
    Column("updated_at", TIMESTAMP(timezone=True), server_default=text('NOW()'), onupdate=text('NOW()')),
)
